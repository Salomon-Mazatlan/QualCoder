...
"/* Scoped to #centralwidget so a theme stylesheet cannot outrank these rules. */\n"
"\n"
...
"}\n"
"#centralwidget QToolButton:hover { background: rgba(127, 127, 127, 0.20); }\n"
"#centralwidget QToolButton:pressed { background: rgba(127, 127, 127, 0.34); }\n"
"#centralwidget QToolButton:checked { background: rgba(127, 127, 127, 0.30); }\n"
"\n"
"#centralwidget QLabel { background: transparent; }\n"
"#centralwidget QCheckBox { background: transparent; }\n"
"#centralwidget QTabBar { background: transparent; }\n"
"#centralwidget, #splitter, #sidebar, #tab_action_log, #tab_manage, #tab_coding,\n"
"#tab_reports, #tab_ai_agent { background: transparent; }\n"
"\n"
"#centralwidget QTabWidget::pane { border: none; }\n"
"#centralwidget QTabBar::tab { border: none; padding: 6px 14px; margin-right: 4px; border-radius: 8px; }\n"
"#centralwidget QTabBar::tab:selected { background: rgba(127, 127, 127, 0.26); }\n"
"#centralwidget QTabBar::tab:hover { background: rgba(127, 127, 127, 0.14); }\n"
"\n"
"#centralwidget QTextEdit#textEdit, #centralwidget QFrame#sidebar_frame {\n"
"    border: 1px solid rgba(127, 127, 127, 0.30);\n"
"    border-radius: 8px;\n"
"}\n"
"\n"
"#centralwidget QLineEdit { border: 1px solid rgba(127, 127, 127, 0.40); border-radius: 8px; padding: 2px 8px; }\n"
"#centralwidget QLineEdit:focus { border: 1px solid rgba(46, 134, 222, 0.85); }\n"
"#centralwidget QComboBox { border: 1px solid rgba(127, 127, 127, 0.40); border-radius: 8px; padding: 2px 8px; }\n"
"\n"
"#centralwidget QSplitter::handle { background: transparent; }\n"
"\n"
"#centralwidget QScrollBar:vertical { border: none; background: transparent; width: 10px; margin: 0px; }\n"
"#centralwidget QScrollBar:horizontal { border: none; background: transparent; height: 10px; margin: 0px; }\n"
...
"    min-width: 24px;\n"
"}\n"
"#centralwidget QScrollBar::handle:vertical:hover, #centralwidget QScrollBar::handle:horizontal:hover {\n"
"    background: rgba(127, 127, 127, 0.70);\n"
"}\n"
"#centralwidget QScrollBar::add-line, #centralwidget QScrollBar::sub-line { width: 0px; height: 0px; }\n"
"#centralwidget QScrollBar::add-page, #centralwidget QScrollBar::sub-page { background: transparent; }\n"
"")
        ...
        self.verticalLayout_manage.setContentsMargins(0, 8, 0, 0)
        self.verticalLayout_manage.setSpacing(0)
        ...
        self.verticalLayout_coding.setContentsMargins(0, 8, 0, 0)
        self.verticalLayout_coding.setSpacing(0)
        ...
        self.verticalLayout_reports.setContentsMargins(0, 8, 0, 0)
        self.verticalLayout_reports.setSpacing(0)
